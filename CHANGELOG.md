...
- pay X-LNURLcash challenges with a bearer note (#20)
...
- try the next note when one was already spent elsewhere
...
- replace legacy bolt11 decoder with farrier
...
- double-pay guards, reconcile tool, daily cap and hardened HTTP transport (#44)
